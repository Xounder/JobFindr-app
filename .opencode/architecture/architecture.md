# Job Search Aggregator — Architecture Documentation

This folder contains the complete architectural documentation for the project.
...
- [12-trust-engine.md](./12-trust-engine.md)
...
- [17-observability-architecture.md](./17-observability-architecture.md)
- [18-deployment-architecture.md](./18-deployment-architecture.md)
