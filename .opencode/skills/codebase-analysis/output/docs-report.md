...
Generated: 2026-06-06T00:50:59.024Z
...
── All Headings (279) ──
  ...
  phase 4: discuss with user                    .opencode/agents/00-planning-agent.md
  phase 4b: present plan structure before creating files (direct chat only) .opencode/agents/00-planning-agent.md
...
── Files Scanned ──
  ...
  .opencode/agents/01-product-manager.md  [13 headings, 2 code blocks]
  .opencode/agents/02-tech-lead.md  [15 headings, 1 code blocks]
  ...
  .opencode/architecture/01-system-overview.md  [7 headings, 1 code blocks]
  ...
  .opencode/architecture/19-engineering-guidelines.md  [8 headings, 2 code blocks]
  ...
  .opencode/architecture/commit-pattern.md  [7 headings, 2 code blocks]
  .opencode/commands/doc-audit.md  [5 headings, 2 code blocks]
  ...
  .opencode/skills/codebase-analysis/SKILL.md  [13 headings, 2 code blocks]
  ...
  .opencode/skills/continuous-learning/SKILL.md  [4 headings, 1 code blocks]
  .opencode/skills/doc-audit/SKILL.md  [11 headings, 1 code blocks]
