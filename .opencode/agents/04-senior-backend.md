...
9. Update `pipeline.yaml`: `steps.senior-backend.status: "completed"`, `current_step: "qa"`
10. Trigger QA Reviewer Agent via Task tool (`subagent_type: "QA Reviewer"`, backend instance)
